...
\documentclass[10pt,a4paper,sans]{./moderncv/moderncv}   % possible options include font size ('10pt', '11pt' and '12pt'), paper size ('a4paper', 'letterpaper', 'a5paper', 'legalpaper', 'executivepaper' and 'landscape') and font family ('sans' and 'roman')
...
% \section{个人资料}
% \hspace{1.1cm}\cvdoubleitem{出生:}{1989年8月}{家乡:}{山东济南}
...
\tllabelcventry{2008}{2012}{2008--2012}{学士}{北京邮电大学}{专业: 信息工程}{主要课程: 数据结构, 信息论, 通信原理, 计算机网络}{}
\tlcventry{2012}{0}{硕士}{北京邮电大学}{专业: 信息与通信工程}{研究方向: 移动互联网}{}

\section{专业技能}
\cvitem{}{熟练掌握Linux基本操作，以Arch Linux为日常操作系统}
\cvitem{}{熟练掌握C、C++、Android应用开发，了解Python、PHP、MySQL、Bash、Makefile}
\cvitem{}{熟悉Vim、Eclipse、svn、git等开发工具}
\cvitem{}{掌握Markdown、LaTeX编写文档}
\cvitem{}{大学英语六级考试534分}
...
\item 承担测试引擎的JNI实现，参与用户数据收集；
\item 熟悉Android JNI编程、HTTP协议，了解PHP、MySQL基本操作，加强了团队合作能力。
\end{itemize}}

\tllabelcventry{2013.5}{2014.1}{2013.7--2014.1}{双卡智能手机四大基本应用开发}{北京电信天翼终端公司}{}{}{%
\begin{itemize}%
\item 针对电信Android双卡双待手机，日历、通讯录、拨号盘、短信的应用开发，以Android 4.1的应用源码为基础的二次开发，修改和增加功能以增进用户体验；
\item 项目总体负责，承担日历、通讯录、拨号盘三个模块的开发；
\item 熟练掌握Android应用开发，熟悉原生应用源码，掌握Android系统编译。
\end{itemize}}

\tllabelcventry{2013.5}{2013.9}{2013.7--2013.11}{运营商管道化现状研究}{北京移动}{}{}{%
\begin{itemize}%
\item 工作内容 1;
\item 工作内容 2;
\item 工作内容 3。
...
\tllabelcventry{2014}{0}{2014.1--}{欧盟国际科研人员交流计划移动云计算项目EU FP7 IRSES MobileCloud Project}{哥廷根大学等}{}{}{%
\begin{itemize}%
\item 工作内容 1;
\item 工作内容 2;
\item 工作内容 3。
