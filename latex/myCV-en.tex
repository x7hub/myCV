...
\setlength{\hintscolumnwidth}{1.5cm}           % 如果你希望改变日期栏的宽度
...
\hspace{1.4cm}\cvdoubleitem{Gender:}{Male}{Birthdate:}{Aug. 1989}
...
\cvitem{}{Skilled in Android, C development. Familiar with C++, Python, Bash}
...
\begin{itemize}%
\item Achieve data interoperability for 3G and WiFi networks in embedded Linux systems,  to enable terminal devices with WiFi capabilities to enjoy 3G Internet connection, and optimize energy consumption for a variety of situations;
...
\cvitem{}{2011-2013 Third, Second and First class Scholarship of Beijing University of Posts and Telecommunications}
