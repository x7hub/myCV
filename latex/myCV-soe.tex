...
\vspace{-8pt}
\begin{itemize}%
\item 参考苹果的iBeacon和谷歌的Nearby，利用蓝牙、WiFi、声波等，在Android上的近距离通信技术的探索
...
\vspace{-8pt}
\begin{itemize}%
\item 针对Android终端不同类型的业务量化QoS评价
\item 负责开发，承担开发网络质量参数收集平台，协助分析网络QoS体系
...
\item 负责理论研究和开发，基于HTTP的动态自适应流媒体(DASH)的研究，在IEEE会议中发表了论文
...
% \item 负责理论研究，承担智能手机利用网络信息的定位算法的分析研究。
...
\item 负责开发，承担核心测试引擎的JNI实现，用户数据收集
...
\cvitem{}{\textcolor{color1}{\large$\circ$}~~担任班级生活委员，曾担任学习委员，多次组织班级活动}
\cvitem{}{\textcolor{color1}{\large$\circ$}~~参与过国际合作项目和课程，参加过国际会议}
