...
\vspace{-8pt}
\begin{itemize}%
\item 智能手机上的近距离通信技术的探索，在Android手机上实现了苹果的iBeacon协议，利用超声波实现了手机间的声波通信
\item 微博客户端的性能测试，自动测试脚本，研究提高图形性能的方案
...
\vspace{-8pt}
\begin{itemize}%
\item 针对手机终端不同类型的业务量化QoS评价，承担开发网络质量参数收集平台，协助分析网络QoS体系
...
\item 研究传统云计算在移动互联网环境的融合与应用，负责基于HTTP的动态自适应流媒体(DASH)的研究，在IEEE会议中发表了论文，已被EI检索收录
...
\vspace{-8pt}
\begin{itemize}%\setlength{\itemsep}{1pt }
\item 分析微信等应用为运营商带来的挑战，分析运营商的管道价值现状及提升策略，负责研究手机利用运营商网络信息的定位算法。
...
\vspace{-8pt}
\begin{itemize}%\setlength{\itemsep}{1pt }
\item 针对电信Android双卡双待手机的应用开发，承担日历、通讯录、拨号盘三个模块的开发
% \item Android编程~~~~~~~~\textcolor{color1}{\large$\circ$}~~修改Google原生应用
\end{itemize}}

\tllabelcventry{2013}{2013.7}{2013.1--2013.7}{无线网络质量测量平台}{}{}{日本电信 NTT DoCoMo}{%
\vspace{-8pt}
\begin{itemize}%\setlength{\itemsep}{1pt }
\item Android手机网络测速软件``手机网速摇摇看''，各大应用市场可下载，承担核心测试引擎的JNI实现，用户数据收集
...
\cvitem{}{\textcolor{color1}{\large$\circ$}~~2011-2013年 北京邮电大学三等、二等、一等奖学金}
\cvitem{}{\textcolor{color1}{\large$\circ$}~~2013年 泛网无线通信教育部重点实验室优秀学生}


\section{其他信息}

\cvitem{}{\textcolor{color1}{\large$\circ$}~~活动经历：担任班级生活委员，曾担任学习委员，多次组织班级活动}

\cvitem{}{\textcolor{color1}{\large$\circ$}~~业余时间组织兴趣团队开发软件，能合理地协调团队成员}
