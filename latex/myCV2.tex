...
\usepackage[scale=0.82,top=2.5cm,bottom=0cm]{geometry}
...
\vspace{-25pt}
\httplink[博客：x7res.info]{x7res.info}\\
\httplink[Github：github.com/x7hub]{github.com/x7hub}
% 论文：On adaptive live streaming in mobile cloud computing environments with D2D cooperatio（IEEE）http://t.cn/RhMwYNA
% \httplink[论文：t.cn/RhMwYNA(IEEE)]{t.cn/RhMwYNA}
\vspace{8pt}
...
\item 理论研究和开发，承担基于HTTP的动态自适应流媒体(DASH)的研究，开发演示系统，发表了论文：On adaptive live streaming in mobile cloud computing environments with D2D cooperation.
...
\cvitem{}{熟练掌握Java、C应用开发，熟悉PHP、Shell}
