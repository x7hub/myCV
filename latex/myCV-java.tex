...
\item Java编程~~~~~~~~\textcolor{color1}{\large$\circ$}~~Shell编程~~~~~~~~\textcolor{color1}{\large$\circ$}~~Python编程
\end{itemize}}
...
\item 开发，合作开发Android应用，独立开发后台服务器
\item Java编程~~~~~~~~\textcolor{color1}{\large$\circ$}~~PHP\&MySQL编程
\end{itemize}}
...
\item Java编程~~~~~~~~\textcolor{color1}{\large$\circ$}~~PHP\&MySQL编程%~~~~~~~~\textcolor{color1}{\large$\circ$}~~阅读文献
\end{itemize}}
...
\item Java编程%~~~~~~~~\textcolor{color1}{\large$\circ$}~~阅读文献
\end{itemize}}
...
\item Java\&C编程~~~~~~~~\textcolor{color1}{\large$\circ$}~~PHP\&MySQL编程
\end{itemize}}
