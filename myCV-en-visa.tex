...
\address{Beijing University of Posts and Telecommunications, No.10 Xitucheng Road}{Haidian District, Beijing, CHINA, 100876}            % 可选项、如不需要可删除本行
\phone[mobile]{(86) 012 3456 7890}              % 可选项、如不需要可删除本行
% \phone[fixed]{+2~(345)~678~901}               % 可选项、如不需要可删除本行
% \phone[fax]{+3~(456)~789~012}                 % 可选项、如不需要可删除本行
\email{as\_to@msn.cn}                    % 可选项、如不需要可删除本行
...
\hspace{1.4cm}\cvdoubleitem{Nationality:}{Chinese}{Marital:}{single}
% \hspace{1.4cm}\cvdoubleitem{Foreign Language:}{English}{}{}
% \hspace{1.4cm}\cvitem{Address:}{Beijing University of Posts and Telecommunications, No.10 Xitucheng Road, Haidian District, Beijing, CHINA, 100876}
